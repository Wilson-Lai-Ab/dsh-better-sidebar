	...
	factory: (require) => {
		...
		*/
		...
		function CenterPreview(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: clsx(sidebar_module_css_default.centerPreview, chatting && sidebar_module_css_default.centerPreviewHidden),
				style: {
					left,
