	...
	factory: (require) => {
		...
		*/
		...
		function previewOverlayBottom(options) {
			...
			const composerInset = composerTop === void 0 ? 0 : Math.max(0, hostBottom - composerTop + gap);
