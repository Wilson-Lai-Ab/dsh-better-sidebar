window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		var init_selection_payload = __esmMin((() => {
			init_paths();
		}));
		//#endregion
		...
		*/
		...
		var FILE_SOURCE, FILE_REF_MIME;
		var init_file_ref = __esmMin((() => {
			init_paths();
			init_selection_payload();
			FILE_SOURCE = "file";
			FILE_REF_MIME = "application/x-dsh-file-ref";
		}));
		//#endregion
		...
		*/
		...
		var init_conversation_draft = __esmMin((() => {
		...
		*/
		var RenderBoundary;
		var init_RenderBoundary = __esmMin((() => {
			init_locales();
			init_sidebar_module_css();
			RenderBoundary = class extends react.Component {
				state = { error: null };
		...
		*/
		...
		function CenterTabView(props) {
			...
			const snapshot = (0, react.useSyncExternalStore)((0, react.useCallback)((listener) => store.subscribe(listener), [store]), store.getSnapshot);
			const state = snapshot.state;
			const tab = state?.centerTabs.find((candidate) => candidate.id === tabId);
			const cwd = snapshot.sessionId === sessionId ? ctx.sessions?.list.getSnapshot().byId[sessionId]?.cwd : void 0;
			const onToggleDir = (0, react.useCallback)((path) => {
				store.reduce((s) => toggleExpanded(s, path));
			}, [store]);
			const onReferenceFile = (0, react.useCallback)((path) => {
			...
			const onOpenDiff = (0, react.useCallback)((diffTab) => {
				store.reduce((s) => openDiffTab(s, CENTER_PANE_ID, diffTab));
			}, [store]);
			if (state === void 0 || tab === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: sidebar_module_css_default.centerView,
				children: t("loading")
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: sidebar_module_css_default.centerView,
		...
		function registerConversationViews(ctx, store) {
			...
			const sync = () => {
				...
				for (const tab of tabs) {
					...
					}, (props) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CenterTabView, {
						tabId,
						ctx,
						store,
		...
		*/
		function applyDedupe(state, tab, descriptor, prefs) {
			...
			if (tab.type === "editor" || tab.type === "diff") return dockTabToCenter(state, "seed", tab.id, tab, prefs.centerTabOverflow, prefs.centerTabMax);
		...
		*/
		...
		function useSessionEdits(ctx, sessionId, cwd) {
			...
			const snapshot = (0, react.useSyncExternalStore)((0, react.useCallback)((listener) => session?.subscribe(listener) ?? (() => {}), [session]), (0, react.useCallback)(() => session?.getSnapshot() ?? emptySnap, [session]));
			...
			*  changes ('MM') appears in BOTH staged and modified. */
			...
			const refresh = (0, react.useCallback)(async (nextRepo) => {
				...
				try {
					...
					if (statusResult.root !== void 0) setRepoRoot(statusResult.root);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							repos.length > 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
										value: "directory",
										children: t("groupByDirectory")
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
										value: "module",
										children: t("groupByModule")
									})
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					status !== null && status.isRepo && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
							...
							closeLabel: t("cancel"),
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: sidebar_module_css_default.gitRepoList,
								role: "listbox",
								"aria-label": t("gitRepo"),
								children: repos.map((repo) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									role: "option",
									"aria-selected": repo.root === repoRoot,
									className: sidebar_module_css_default.gitRepoItem,
									onClick: () => {
										setRepoPickerOpen(false);
										refresh(repo.root);
									},
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: sidebar_module_css_default.gitRepoName,
										children: repo.name
									}), repo.rel !== "." && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: sidebar_module_css_default.gitRepoRel,
										children: repo.rel
									})]
								}, repo.root))
							})
		...
		*/
		function useHostHeaderTabSync(ctx, store) {
			(0, react.useEffect)(() => {
				let header;
				const tabOf = (button) => {
					const tabs = store.getSnapshot().state?.centerTabs ?? [];
