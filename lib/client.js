	...
	factory: (require) => {
		...
		*/
		...
		function ExplorerView(props) {
			...
			const [lhEdits, setLhEdits] = (0, react.useState)(null);
			const sessionEdits = useSessionEdits(ctx ?? {}, sessionId, cwd);
			const builtinEdits = (0, react.useMemo)(() => pendingEdits(sessionId, sessionEdits.latest).map((edit) => ({
				path: edit.path,
				kind: edit.kind
			})), [
				sessionId,
				sessionEdits.latest,
				sessionEdits.pending
			]);
			const sessionKinds = (0, react.useMemo)(() => sessionKindByPath(cwd, lhEdits ?? builtinEdits), [
				cwd,
				lhEdits,
				builtinEdits
			]);
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: clsx(sidebar_module_css_default.reviewPath, color, edit.kind === "delete" && sidebar_module_css_default.gitDeletedText),
									children: edit.path
								})
							]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		*/
		...
		function EditorHost(props) {
			...
			const writeStamp = review === void 0 ? "" : `${review.seq ?? ""}:${review.turn ?? ""}:${review.kind}`;
			const seenWrite = (0, react.useRef)({
				path: "",
				stamp: ""
			});
