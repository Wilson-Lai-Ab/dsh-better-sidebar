...
export declare const zh: {
    explorer: string;
    findFile: string;
    findFilePlaceholder: string;
    findFileEmpty: string;
    git: string;
    terminal: string;
    editor: string;
    openExplorer: string;
    ...
    dropToBottom: string;
    dropToConversation: string;
    conversationTab: string;
    returnToSidebar: string;
    ...
    settingsCenterTabsTitle: string;
    settingsCenterTabsDesc: string;
    settingsCenterTabsScroll: string;
    settingsCenterTabsScrollDesc: string;
    settingsCenterTabsWrap: string;
    settingsCenterTabsWrapDesc: string;
    settingsCenterTabMaxTitle: string;
    settingsCenterTabMaxDesc: string;
