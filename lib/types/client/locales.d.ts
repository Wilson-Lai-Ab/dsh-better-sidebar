...
export declare const zh: {
    ...
    reviewKeep: string;
    reviewUndo: string;
    reviewKeepHunk: string;
    reviewUndoHunk: string;
    reviewKeepAll: string;
    reviewUndoAll: string;
    reviewKept: string;
    reviewUndone: string;
    reviewEmpty: string;
    reviewCaughtUp: string;
    reviewFilterPending: string;
    reviewFilterAll: string;
    reviewFilterDone: string;
    reviewDoneSessionsTitle: string;
    reviewDoneSessionsDesc: string;
    reviewSessionFiles: string;
    reviewAdded: string;
    reviewEdited: string;
    reviewDeleted: string;
    reviewBarHint: string;
    reviewTurn: string;
    reviewTurnUnknown: string;
    reviewNoPrompt: string;
    reviewFileCount: string;
    disconnected: string;
    exited: string;
    noSession: string;
