...
export declare function DiffView({ diff, untrackedPath, untrackedContent, ctx, sessionId, cwd, onDragFile, onOpenFileAbove }: DiffViewProps): import("react").JSX.Element | null;
