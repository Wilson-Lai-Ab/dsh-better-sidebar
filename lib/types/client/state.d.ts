...
export declare const CENTER_PANE_ID = "center";
...
export declare function findTab(state: SidebarState, tabId: string): SidebarTab | undefined;
/** Pane id hosting a tab, or the conversation-header strip. */
export declare function findPaneOfTab(state: SidebarState, tabId: string): string;
 ...
 */
export declare function takeDraggedTab(state: SidebarState, fromPane: string, tabId: string, seed?: SidebarTab): {
    state: SidebarState;
    tab: SidebarTab;
} | undefined;
export declare function moveTabToEdge(state: SidebarState, fromPane: string, tabId: string, toPane: string, zone: DropZone, seed?: SidebarTab): SidebarState;
/**
...
export declare function moveTab(state: SidebarState, fromPane: string, tabId: string, toPane: string, index?: number, seed?: SidebarTab): SidebarState;
 ...
 */
export declare function openHistoryTab(state: SidebarState, tab: SidebarTab): SidebarState;
 ...
 */
export declare function dockTabToBottom(state: SidebarState, fromPane: string, tabId: string, seed?: SidebarTab): SidebarState;
/**
 ...
 */
export declare function dockTabToCenter(state: SidebarState, fromPane: string, tabId: string, seed?: SidebarTab, overflow?: 'scroll' | 'wrap', max?: number): SidebarState;
/**
 * Wrap-mode overflow: keep the newest `max` conversation-header tabs and
 * drop the oldest. Scroll mode never trims.
 */
export declare function trimCenterTabs(state: SidebarState, overflow: 'scroll' | 'wrap', max: number): SidebarState;
/**
 ...
 */
export declare function promoteCenterTabToEditor(state: SidebarState, fromId: string, editor: SidebarTab): SidebarState;
/**
 * Return a conversation-header tab to a workbench pane (right tree by default).
 */
export declare function undockTabFromCenter(state: SidebarState, tabId: string, toPane?: string): SidebarState;
