...
export declare function editorTabForPath(ctx: Context, sessionId: string, path: string): SidebarTab;
...
export declare function openSidebarFileAbove(ctx: Context, store: SidebarStore, sessionId: string, path: string): void;
