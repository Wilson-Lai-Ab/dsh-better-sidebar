/**
 * One-shot "scroll this editor to a line span" bus. Search hits and
 * composer chip clicks stash a range against the absolute path; the text
 * editor consumes it when the view is ready (new tab or already open).
 */
